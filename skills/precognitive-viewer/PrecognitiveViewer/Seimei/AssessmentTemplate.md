...
# 本スキルのルート（skills/precognitive-viewer）を sys.path に追加し package を import
# （Seimei/ へのパス追加は PrecognitiveViewer/__init__.py の bootstrap が自動で行う）
sys.path.insert(0, str(Path("skills/precognitive-viewer").resolve()))
import PrecognitiveViewer  # noqa: F401  (bootstrap)
